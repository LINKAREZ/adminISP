            ...
            <x-card title="Registros de Auditoría" subtitle="Historial completo de acciones realizadas en el sistema" icon="fa-history" variant="primary">
                    ...
                    <form method="GET" action="{{ route('auditoria.index') }}" class="mb-2">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="small d-block mb-1">Modelo</label>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="small d-block mb-1">Fecha Desde</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="small d-block mb-1">Fecha Hasta</label>
                    ...
                    <div class="table-responsive">
                        <table id="tablaAuditoria" class="table table-hover table-striped mb-0">
