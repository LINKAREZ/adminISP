                    ...
                    @endif
                        ...
                        <div class="tab-content mt-3" id="servicioTabContent">
                            ...
                            <div class="tab-pane fade" id="content-tab-ubicacion" role="tabpanel" aria-labelledby="tab-ubicacion">
                                ...
                                {{-- Ubicación GPS: mapa y coordenadas (inline para evitar problemas de caché/componente) --}}
                                @php
                                    $mapIdServicio = 'map-servicio';
                                    $latVal = old('ubicacion_latitud', $servicio->ubicacion?->latitud);
                                    $lngVal = old('ubicacion_longitud', $servicio->ubicacion?->longitud);
                                @endphp
                                <div class="form-group mapa-gps-wrapper" data-map-id="{{ $mapIdServicio }}" data-name-lat="ubicacion_latitud" data-name-lng="ubicacion_longitud">
                                    <label><i class="fas fa-map-marker-alt mr-1"></i> Ubicación GPS</label>
                                    <small class="d-block text-muted mb-2">Haz clic en el mapa para marcar el punto, o usa el botón para tu ubicación. Opcional.</small>
                                    <div class="row align-items-end mb-2">
                                        <div class="col-md-5">
                                            <label class="small text-muted mb-0">Latitud</label>
                                            <input type="text" name="ubicacion_latitud" id="ubicacion_latitud-input" class="form-control form-control-sm" placeholder="Ej: -12.046374" value="{{ $latVal }}" readonly>
                                        </div>
                                        <div class="col-md-5">
                                            <label class="small text-muted mb-0">Longitud</label>
                                            <input type="text" name="ubicacion_longitud" id="ubicacion_longitud-input" class="form-control form-control-sm" placeholder="Ej: -77.042793" value="{{ $lngVal }}" readonly>
                                        </div>
                                        <div class="col-md-2">
                                    ...
                                    <div id="{{ $mapIdServicio }}" class="border rounded bg-light" style="height: 280px; width: 100%; min-height: 280px;">
