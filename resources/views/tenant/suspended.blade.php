...
<head>
    ...
    <title>Cuenta suspendida - Admin ISP</title>
...
<body>
    <div class="card shadow">
        <div class="card-body text-center p-5">
            ...
            <p class="text-muted mb-4">El acceso a su panel esta temporalmente suspendido. Contacte al administrador o regularice su suscripcion.</p>
